...
- [浏览器的渲染过程，DOM 树和渲染树的区别](#浏览器的渲染过程dom-树和渲染树的区别)
- [CSS 会阻塞 DOM 解析吗](#css-会阻塞-dom-解析吗)
- [重绘和回流（重排）的区别和关系](#重绘和回流重排的区别和关系)
- [如何最小化重绘 (repaint) 和回流 (reflow)](#如何最小化重绘-repaint-和回流-reflow)
