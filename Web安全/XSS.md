...
- [XSS 跨站脚本攻击](#xss-跨站脚本攻击)
  ...
  - [XSS 防御](#xss-防御)
    - [转义字符](#转义字符)
      - [对于会在 DOM 中出现的字符串（用户数据）](#对于会在-dom-中出现的字符串用户数据)
      - [对于可能出现在 DOM 元素属性上的数据](#对于可能出现在-dom-元素属性上的数据)
      - [避免 JS 中的插入](#避免-js-中的插入)
      - [富文本](#富文本)
      - [使用 npm 包来简化操作](#使用-npm-包来简化操作)
